...
[L1] = KEYMAP(  // layer 0 : default
        // left hand
        KC_ESC,         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_LEFT,
        KC_TAB,         KC_X,         KC_V,   KC_L,   KC_C,   KC_W,   TG(MDIA),
        KC_CAPS,        KC_U,         KC_I,   KC_A,   KC_E,   KC_O,
        KC_LSFT,        kUE,          kOE,    kAE,    KC_P,   KC_Z,   ALL_T(KC_NO),
        LT(MDIA,KC_GRV),KC_QUOT,      LALT(KC_LSFT),  KC_LALT ,KC_LGUI,
                                              ALT_T(KC_APP),  KC_LGUI,
                                                              KC_HOME,
                                               LT(L3,KC_BSPC),LT(L4,KC_ENT),CTL_T(KC_ESC),
        // right hand
             KC_RGHT,     KC_6,   KC_7,  KC_8,   KC_9,   KC_0,             KC_MINS,
             TG(MDIA),    KC_K,   KC_H,  KC_G,   KC_F,   KC_Q,             KC_BSLS,
                          KC_S,   KC_N,  KC_R,   KC_T,   KC_D,             KC_Y,
             MEH_T(KC_NO),KC_B,   KC_M,  KC_COMM,KC_DOT, KC_J,   KC_RSFT,
                                  KC_RGUI , KC_LEFT,KC_DOWN,KC_UP,         KC_RIGHT,
             KC_LALT,        CTL_T(KC_ESC),
             KC_PGUP,
             CTL_T(KC_TAB),LT(L4,KC_ENT), LT(L3,KC_SPACE)
    ),
...
[L3] = KEYMAP(
       ...
       KC_TRNS, KC_EXLM, KC_LABK,KC_RABK, KC_EQL,  KC_AMPR, KC_F12,
...
[L4] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_ENT,  KC_TRNS, KC_TRNS,
...
static void compose(keyrecord_t *record, uint16_t key) {
    ...
    register_code(dead_key);
    unregister_code(dead_key);
